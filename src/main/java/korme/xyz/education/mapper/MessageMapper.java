...
public interface MessageMapper {
    ...
    * 插入message
    * */
    @Insert("INSERT INTO `education`.`message`(`userId`, `messageType`, `commentId`,`content`) VALUES (#{userId},#{messageType},#{commentId},#{content})")
    void insertMessage(@Param("userId")int userId,@Param("messageType")int messageType,@Param("commentId")int commentId,@Param("content")String content);
